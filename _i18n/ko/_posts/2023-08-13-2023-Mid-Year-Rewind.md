...
1. [시작하며](#시작하며)
2. [Flutter Web 페이지 첫 배포](#Flutter-Web-페이지-첫-배포)
3. [신규 기능 배포](#신규-기능-배포) 
4. [블로그에 글 10개 이상 등록](#블로그에-글-10개-이상-등록) 
5. [필라테스 시작](#필라테스-시작) 
6. [메모어 참여](#메모어-참여) 
7. [식물을 집에 기르기 시작함](#식물을-집에-기르기-시작함) 
8. [간간히 영어 공부](#간간히-영어-공부) 
9. [마치며](#마치며)
...
2023 년 7 월 3 일, [신규 기능 배포](#신규-기능-배포) 를 마치고 연차를 하루 냈다.
